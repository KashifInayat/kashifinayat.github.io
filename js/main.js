$(document).ready(function () {
  ...
  'use strict'
    // if ($('#recentUpdatesUl li').length <= 10) {
    //     $("#toggleButton").hide();
    // }
    // var initialCounter = 0;
    // $('#recentUpdatesUl li').each(function (i) {
...
//         document.getElementById("toggleButton").css = "cursor:pointer !important";
//         status = "more";
//     } else if (status == "more") {


//         var lessInitialCounter = 0;
//         $('#recentUpdatesUl li').each(function (i) {
//             $(this).attr('rel');
